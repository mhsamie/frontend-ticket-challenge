...
export const handlers = [
    ...
    // POST handler for '/api/maps/:map_id/ticket' endpoint
    // Reserves a seat on the specified map and creates a ticket for it
    http.post("/api/maps/:map_id/ticket", async ({ request, params }) => {
